                ...
                <div className="relative w-full max-w-2xl mx-auto mb-8 md:mb-12 group perspective-1000 mt-4 md:mt-8">
                    ...
                    <svg viewBox="0 0 512 512" className="w-full max-w-lg md:max-w-2xl h-auto drop-shadow-[0_0_30px_rgba(255,100,0,0.4)] relative z-10" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <g className="text-primary/70 drop-shadow-[0_0_5px_rgba(255,100,0,0.9)]" strokeDasharray="6 6" strokeWidth="2.5">
                            {/* Chuck / Rib */}
                            <path d="M 310 165 Q 315 220 300 285 L 295 325" />
                            {/* Rib / Short Loin */}
                            <path d="M 235 165 Q 235 220 240 255" />
                            {/* Short Loin / Sirloin */}
                            <path d="M 175 165 Q 170 200 185 245" />
                            {/* Sirloin / Rump */}
                            <path d="M 130 170 Q 120 200 125 245" />
                            {/* Rump / Round */}
                            <path d="M 90 220 Q 110 230 120 245" />

                            {/* Horizontal separator (Brisket/Plate/Flank) */}
                            <path d="M 145 285 Q 220 250 350 255" />

                            {/* Plate / Flank */}
                            <path d="M 215 260 Q 200 300 215 340" />

                            {/* Front Shank / Brisket */}
                            <path d="M 330 330 Q 350 350 360 400" />
                            {/* Back Shank / Round */}
                            <path d="M 125 330 Q 130 350 145 375" />
                        </g>

                        {/* GLOWING LABELS */}
                        <g fill="currentColor" stroke="none" fontWeight="900" fontSize="16" letterSpacing="1" className="text-white drop-shadow-[0_0_8px_rgba(255,200,100,0.8)]" style={{ fontFamily: 'Inter, sans-serif' }}>
                            <text x="330" y="210">CHUCK</text>
                            <text x="250" y="210">RIB</text>
                            <text x="180" y="195" transform="rotate(-15 180 195)">SHORT</text>
                            <text x="180" y="215" transform="rotate(-15 180 215)">LOIN</text>
                            <text x="135" y="215" transform="rotate(-15 135 215)">SIRLOIN</text>

                            <text x="100" y="195">RUMP</text>
                            <text x="70" y="270">ROUND</text>

                            <text x="330" y="300">BRISKET</text>
                            <text x="240" y="300">PLATE</text>
                            <text x="160" y="300">FLANK</text>

                            {/* Shanks */}
                            <text x="310" y="380" fontSize="12">SHANK</text>
                            <text x="100" y="380" fontSize="12">SHANK</text>
                        </g>
                    </svg>
                </div>
